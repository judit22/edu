...
class Calculator():
    def __init__(self):
        training_data_x,training_data_y=pd.read_csv('C:/Users/teves/Downloads/generated_data_x.csv'),pd.read_csv('C:/Users/teves/Downloads/generated_data_y.csv')    
    ...
    def calc_diff(self, game):
        ...
        prev_diff=int(np.where(data[7:15])[0]+1)
        prev_time= data[-2]
        prev_score= data[0]
        diff=prev_diff
        ...
        if pred>-1:
            ...
            game.user.difficulty+=success_rate*max_diff_time_rate+pred/5
